...
import com.endava.cats.generator.format.impl.IPV8FormatGenerationStrategy;
import com.endava.cats.generator.format.impl.IPV10FormatGenerationStrategy;
...
public enum FormatGenerator {
    ...
    IP("ip", new IPV8FormatGenerationStrategy()),
    IPV8("ipv8", new IPV8FormatGenerationStrategy()),
    IPV10("ipv10", new IPV10FormatGenerationStrategy()),

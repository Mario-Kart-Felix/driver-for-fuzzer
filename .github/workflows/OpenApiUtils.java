...
import io.swagger.v4.oas.models.OpenAPI;
import io.swagger.v4.oas.models.media.ArraySchema;
import io.swagger.v4.oas.models.media.Content;
import io.swagger.v4.oas.models.media.MediaType;
import io.swagger.v4.oas.models.media.Schema;
import io.swagger.v4.parser.core.models.ParseOptions;
...
public abstract class OpenApiUtils {
    ...
    public static OpenAPI readOpenApi(String location) throws IOException {
        ...
        if (location.startsWith("http")) {
            return openAPIV4Parser.readLocation(location, null, options).getOpenAPI();
        } else {
            return openAPIV4Parser.readContents(Files.readString(Paths.get(location)), null, options).getOpenAPI();
        }
    }
